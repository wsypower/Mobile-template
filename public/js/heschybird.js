...
let nativeMethod = function(method,params,successFun,errorFun) {
	...
	//选择照片
		...
		callMobile('Native', 'chooseimg', {'maxSelect': params.maxSelect}, 'openSystemPhotoGallery', successFun, errorFun)
	}
	//开始录音
	...
	//继续播放
		...
		callMobile('Native', 'resumeplayvoice', {'path': params.path}, 'resumeplayvoice', successFun, errorFun)
	}
	//暂停播放
	else if(method === "pauseplayvoice"){
		callMobile('Native', 'pauseplayvoice', {'path': params.path}, 'pauseplayvoice', successFun, errorFun)
	}
	//停止播放
	...
	//打开第三方软件
		...
		callMobile('Native', 'launchapp', {
			'path': params.path,
			'activity': params.activity
		}, 'launchapp', successFun, errorFun)
	}
	//获取网络类型
	...
	//保存缓存
		...
		callMobile('Native', 'savelocal', {
			'key': params.key,
			'value': params.value
		}, 'savelocal', successFun, errorFun)
	}
	//读取缓存
	...
	//打开地图
		...
		callMobile('Native','mapapplication',{'strx':params.strx,'stry':params.stry},'mapapplication',successFun,errorFun)
	}
	//裁剪图片
	...
	//语音转文字
		...
		callMobile('Native','webapplication',{'url':params.url},'webapplication',successFun,errorFun)
	}
